...
public class Runner extends TestCases {
	...
	//tc 23
	public void clickOnRemeberMeCheckBox(String un,String pwd) throws InterruptedException  {
		loginRegister();
	...
	//tc 24
	public void clickOnLostYourPasswordLink(String un,String pwd) throws InterruptedException, IOException {
		loginRegister();
		username.sendKeys(un);
		password.sendKeys(pwd);
		lostpassword.click();
	...
	//tc 25,26,27,28,29
	public void passwordReset(String npw,String rpw) throws InterruptedException {
		loginRegister();
		visibilityOfElement(lostpassword);
		lostpassword.click();
		Assert.assertTrue( lostyourpassword.getText().contains("Lost your password?"));
		System.out.println(  lostyourpassword.getText());
		uname.sendKeys("r757828@gmail.com",Keys.ENTER);
		...
		gmail.sendKeys("r757828@gmail.com",Keys.ENTER);
		visibilityOfElement(gmailPassword);
		gmailPassword.sendKeys("Raju@987",Keys.ENTER);
	...
	//tc 33
	public void CustomerAbletToDoSignUpWithValidEmailAddress() throws InterruptedException {
		visibilityOfElement(popupemail);
		popupemail.sendKeys("r757828@gmail.com");
		popupsubmit.click();
	...
	//tc65,66
	public void productsinthesearch(String un,String pwd,String prd) throws InterruptedException {
		clickOnRemeberMeCheckBox(un, pwd);
	...
	//tc 132
	public void paymentMethod(String un, String pwd) throws InterruptedException {
		clickOnRemeberMeCheckBox(un, pwd);
		loginregister.click();
	...
	//tc137
	public void orderDetails(String un, String pwd) throws InterruptedException, IOException {
	...
	//tc139
	public void dashBoardlogout(String un, String pwd) throws InterruptedException, IOException {
		clickOnRemeberMeCheckBox(un, pwd);
		loginregister.click();
	...
	//tc140
	public void myAccountlogout(String un, String pwd) throws InterruptedException, IOException {
	...
	//tc243
	public void clickingOnTheShopNowButtonItHasToRedirectToThatParticularPage(String un, String pwd) throws InterruptedException, IOException {
		clickOnRemeberMeCheckBox(un, pwd);
	...
	//tc244
	public void clickOnTheShopNowButtonItHasToRedirectToThatParticularPage(String un, String pwd,String x,String y) throws InterruptedException, IOException {
		JavaScrptClass js=new JavaScrptClass(dr);
		clickOnRemeberMeCheckBox(un, pwd);
		js.scrolll(x, y);
